...
namespace eval xspf {
	...
	proc new_type { current_env filename } {
		fas_fastdebug {xspf::new_type $filename}
		upvar $current_env fas_env
		# When a xspf is met, in what filetype will it be by default
		# translated ?
		return ""
	}
	...
	proc display { current_env filename } {
		...
		# it is a file
		::binary::display xspf application/xml $filename fas_env
	}
}
